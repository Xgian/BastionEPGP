...
local function NewInstance(width, height, useFauxScroll)
	...
	scrollArea:SetPoint("BOTTOMRIGHT", dialogBackground, -25, 40)
	...
	local highlightButton = _G.CreateFrame("Button", nil, copyFrame, "UIPanelButtonTemplate")
	highlightButton:SetText("Import All")
	highlightButton:SetWidth(125)

	highlightButton:SetPoint("BOTTOMRIGHT", dialogBackground, -5, 5)
	...
	highlightButton:SetScript("OnMouseUp", function(self, button)
		...
		instance.importFunc(importStr, false)
		_G.HideUIPanel(copyFrame)
	end)

	local import2 = _G.CreateFrame("Button", nil, copyFrame, "UIPanelButtonTemplate")
	import2:SetText("Import In Raid")
	import2:SetWidth(125)

	import2:SetPoint("RIGHT", highlightButton, -130, 0)

	import2:SetScript("OnMouseUp", function(self, button)
		editBox:HighlightText(0)
		editBox:SetFocus()

		local importStr = editBox:GetText()
		instance.importFunc(importStr, true)
		_G.HideUIPanel(copyFrame)
	end)
...
function lib:New(frameTitle, width, height, save)
	...
	local instance = NewInstance(width or DEFAULT_FRAME_WIDTH, height or DEFAULT_FRAME_HEIGHT, false)
